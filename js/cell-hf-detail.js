   ...
   var div=document.getElementById("slidePic");
	for(var i=0;i<spans.length;i++){
	 ...
	 function animate(ele,target){
	     ...
	     var cellSelect=document.getElementsByClassName("cellSelect");
//	     console.log(cellSelect);
         var txt1=document.getElementsByClassName("txt1");
//       console.log(txt1);
         
         cellSelect[0].onclick=function(){
         	if (txt1[0].style.display=="block") {
         		txt1[0].style.display="none";
         	} else{
         		txt1[0].style.display="block";
         	}
         }	
        cellSelect[1].onclick=function(){
         	if (txt1[1].style.display=="block") {
         		txt1[1].style.display="none";
         	} else{
         		txt1[1].style.display="block";
         	}
         }
